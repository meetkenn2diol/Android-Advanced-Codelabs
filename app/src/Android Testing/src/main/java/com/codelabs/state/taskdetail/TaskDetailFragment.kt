...
import com.codelabs.state.EventObserver
import com.codelabs.state.R
import com.codelabs.state.TodoApplication
import com.codelabs.state.data.source.DefaultTasksRepository
import com.codelabs.state.databinding.TaskdetailFragBinding
import com.codelabs.state.tasks.DELETE_RESULT_OK
import com.codelabs.state.util.setupRefreshLayout
import com.codelabs.state.util.setupSnackbar
