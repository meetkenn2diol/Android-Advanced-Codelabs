...
class SpotLightImageView @JvmOverloads constructor(
    ...
    init {
        //Bitmap.Config.ARGB_8888 stores each color in 4 bytes, offers the best quality, and is recommended.
        ...
        // Draw a black rectangle as the Destination (DST) pixel
        ...
        //NOTE: The source bitmap is used for filing the extra space in Shader.TileMode
...
override fun onTouchEvent(motionEvent: MotionEvent?): Boolean {
    ...
    //allowance is made so that the shader effect is not directly below the finger
    shaderMatrix.setTranslate(
