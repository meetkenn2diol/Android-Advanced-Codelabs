...
package com.google.samples.apps.gdgfinder.search
...
import com.google.samples.apps.gdgfinder.network.GdgChapter
import com.google.samples.apps.gdgfinder.search.GdgListAdapter.GdgListViewHolder
import com.google.samples.apps.gdgfinder.databinding.ListItemBinding

class GdgListAdapter(val clickListener: GdgClickListener): ListAdapter<GdgChapter, GdgListViewHolder>(
    DiffCallback
){
