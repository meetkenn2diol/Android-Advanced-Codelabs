...
import com.google.samples.apps.androidtrivia.databinding.FragmentGameBinding
...
class GameFragment : Fragment() {
    ...
    private val numQuestions = Math.min((questions.size + 1) / 2, 1)//3)
    ...
    private fun setQuestion() {
        ...
        // and shuffle them
        answers.shuffle()
        // set a description at the Toolbar title
